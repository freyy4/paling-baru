                    ...
                    <ol>
                            ...
                            <form action="pertanyaan.php" method="post">
                                ...
                                <fieldset>
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="merokok" id="ya_merokok"
                                            value="ya">
                                        <label class="form-check-label" for="ya_merokok">Ya</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="merokok" id="tidak_merokok"
                                            value="tidak">
                        ...
                        <li>
                            <fieldset>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="tato" id="ya_tato" value="ya">
                        ...
                        <li>
                            <fieldset>
                                ...
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label" for="tidak_memegang_daging_babi">Tidak</label>
                                </div>
                            </fieldset>
                        </li>
                        <li>
                        ...
                        <li>
                            <fieldset>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="mata" id="ya_mata" value="ya">
                        ...
                        <li>
                            <fieldset>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="buta_huruf" id="ya_buta_huruf"
                                        value="ya">
                                    <label class="form-check-label" for="ya_buta_huruf">Ya</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="buta_huruf" id="tidak_buta_huruf"
                                        value="tidak">
                        ...
                        <li>
                            <fieldset>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="buta_warna" id="ya_buta_warna"
                                        value="ya">
                                    <label class="form-check-label" for="ya_buta_warna">Ya</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="buta_warna" id="tidak_buta_warna"
                                        value="tidak">
