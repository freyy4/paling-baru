            ...
            <div class="card-body">
                ...
                <form method="post" action="daftar.php" enctype="multipart/form-data" id="myForm">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="email" class="form-control border border-danger" id="email" placeholder="Masukkan E-mail"
                                    name="email">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select id="status" name="status" class="form-control border border-danger">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control border border-danger" id="telepon"
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="file" class="form-control border border-danger" id="foto_ktp" name="foto_ktp"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="file" class="form-control border border-danger" id="pas" name="pas"
                                    accept="image/*,application/pdf">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="kk">Kartu Keluarga (Wajib)</label>
                                <input type="file" class="form-control border border-danger" id="kk" name="kk"
                                    accept="image/*,application/pdf">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="nikah">Buku Nikah / Surat Keterangan Nikah</label>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="cerai">Akte Cerai</label>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6"> 
                            <div class="form-group">
                                ...
                                <select id="negara" name="negara" onchange="populateKeahlian()" class="form-control border border-danger">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <select id="jenis" name="jenis" class="form-control border border-danger">
