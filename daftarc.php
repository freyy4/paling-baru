    ...
    <div class="container">
        <div class="card">
            <div class="card-body">
                ...
                <a href="daftard.php" class="btn btn-danger">Lewati Jika tidak punya Pekerjaan</a>
                <form method="post" action="daftarc.php" enctype="multipart/form-data">
