...
<head>
    ...
    /* Tampilkan tombol hamburger menu pada layar kecil */
    .hamburger-menu {
        display: block;
    }

    /* Gaya untuk elemen header pada layar ponsel */
    header {
        padding: 10px;
        background-color: #ffffff;
    }

    /* Gaya untuk teks yang lebih kecil pada layar ponsel */
    h1 {
        font-size: 1.5rem;
    }

    /* Gaya untuk tata letak grid pada layar ponsel */
    .container {
        display: grid;
    ...
    /* Gaya untuk tombol pada layar ponsel */
    .button {
        padding: 8px 16px;
        font-size: 1rem;
    }
                        ...
                        <table class="table" id="education-table">
                            ...
                            <tbody>
                                <tr class="education-row">
                                    <td>
                                        <input type="text" class="form-control nama-sekolah border border-danger" name="nama_sekolah[]"
                                            placeholder="Masukkan Nama Sekolah" required>
                                    </td>
                                    <td>
                                        <input type="date" class="form-control tgl-masuk border border-danger" name="tgl_masuk_sekolah[]"
                                            required>
                                    </td>
                                    <td>
                                        <input type="date" class="form-control tgl-lulus border border-danger" name="tgl_lulus_sekolah[]"
                                            required>
                                    </td>
                                    <td>
