    ...
    <div class="container">
        <div class="card">
            <div class="card-body">
                ...
                <a href="daftardd.php" class="btn btn-danger">Lewati Jika tidak punya Pelatihan</a>
                <form method="post" action="daftarcc.php" enctype="multipart/form-data">
